...
template <template <typename, typename> class UnaryWithResult, typename Result, typename Argument>
constexpr auto
make_unary_expression(Argument&& arg)
{
    using expression_type = extract_expression_type_t<Argument>;
    if constexpr (std::is_rvalue_reference<Argument&&>{}) {
        return UnaryWithResult<expression_type&&, Result>{static_cast<expression_type&&>(arg)};
    } else {
        return UnaryWithResult<expression_type, Result>{static_cast<expression_type const&>(arg)};
    }
}
...
make_unary_expression(Argument&& arg)
{
    using expression_type = extract_expression_type_t<Argument>;
    if constexpr (std::is_rvalue_reference<Argument&&>{}) {
        return ExpressionType<expression_type&&, N>{static_cast<expression_type&&>(arg)};
    } else {
        return ExpressionType<expression_type, N>{static_cast<expression_type const&>(arg)};
    }
}
//----------------------------------------------------------------------------
...
struct binary_expression {
    ...
    constexpr binary_expression(lhs_type lhs, rhs_type rhs) : lhs_{lhs}, rhs_{rhs} {}
...
struct binary_expression<LHS&&, RHS> {
    ...
    constexpr binary_expression(lhs_type&& lhs, rhs_type rhs) : lhs_{std::move(lhs)}, rhs_{rhs} {}
...
struct binary_expression<LHS, RHS&&> {
    ...
    constexpr binary_expression(lhs_type lhs, rhs_type&& rhs) : lhs_{lhs}, rhs_{std::move(rhs)} {}
    ...
    if constexpr (std::is_rvalue_reference<LHS&&>{}) {
        if constexpr (std::is_rvalue_reference<RHS&&>{}) {
            return ExpressionType<lhs_expression_type&&, rhs_expression_type&&>{
                static_cast<lhs_expression_type&&>(lhs), static_cast<rhs_expression_type&&>(rhs)};
        } else {
            return ExpressionType<lhs_expression_type&&, rhs_expression_type>{
        ...
        return ExpressionType<lhs_expression_type, rhs_expression_type&&>{
            static_cast<lhs_expression_type const&>(lhs), static_cast<rhs_expression_type&&>(rhs)};
    } else {
        return ExpressionType<lhs_expression_type, rhs_expression_type>{
...
template <template <typename, typename, typename> class BinaryWithResult, typename Result,
